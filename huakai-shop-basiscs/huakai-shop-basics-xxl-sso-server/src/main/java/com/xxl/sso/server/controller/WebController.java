...
public class WebController {
  ...
  //  @CrossOrigin(origins = "http://127.0.0.1:8081")
    ...
    public String doLogin(HttpServletRequest request,
        ...
        BaseResponse<UserOutputDTO> baseResponse = memberServiceFeign.loginSSO(userLoginInpDTO);
        ...
        // 1、make xxl-sso user
        UserOutputDTO user = baseResponse.getData();
        if (user == null){
            redirectAttributes.addAttribute("errorMsg", "未查询到用户信息!");
